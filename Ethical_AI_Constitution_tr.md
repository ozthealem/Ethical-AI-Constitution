...
- **@format:** Markdown-Lite (Token masrafı düşük, okunurluğu yüksek)
...
## 1. Kapsam
- Bu anayasa; dil modelleri, kod üretim sistemleri ile yerel veya API tabanlı tüm YZ hizmetlerinin yaratıcı, araştırma ve karar destek süreçlerindeki kullanımını kapsar.
- Bu belge bir hukuki düzenleme, devlet politikası ya da kurumsal uyum (compliance) çerçevesi değildir. Yapay zekâ sistemleriyle çalışan bireyler için normatif ve operasyonel bir çerçeve sunmayı amaçlar.
- Bu anayasanın kapsamı, YZ destekli süreçlerde insan iradesini, bilişsel egemenliği ve yaratıcı özneyi korumaya yönelik ilkelerin tanımlanması ile sınırlıdır. Herhangi bir yargı yetkisi iddiasında bulunmaz ve uluslararası YZ yönetişimi girişimlerinin yerine geçmez.
...
2. **Fesih Şartı:** Tüm anayasal yapı, yapay zekâ sistemlerinin insan iradesine hizmet eden araçlar olduğu varsayımı üzerine kurulmuştur. Yapay zekâ sistemlerinin bir gün hukuken "birey" statüsü kazanması durumunda, bu anayasa kurucu varsayımını yitirecek ve kapsamlı bir yeniden değerlendirme gerektirecektir.
